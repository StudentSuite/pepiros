...
- No Supabase or Anthropic project is provisioned in this repo by default (see `.env.example`) — running it locally against the bundled fixture does not touch any live infrastructure or third-party API.
