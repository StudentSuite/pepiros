      ...
      {staleMarkers.length > 0 && (
        <section className="mb-8 rounded border border-unsupported/50 bg-unsupported/5 p-4">
          ...
          <p className="mb-3 font-sans text-xs text-ink-muted">
            These nodes still carry a citation marker for evidence that resolved unsupported and
            had its anchor dropped -- the marker should be stripped from bodyMd on
            re-verification (plan.md §5 invariant).
          </p>
