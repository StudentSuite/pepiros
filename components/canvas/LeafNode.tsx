...
export function LeafNode({ data }: NodeProps<PepirosNode>) {
  ...
  return (
    ...
    >
      ...
      <div data-lod="title" className="font-sans text-2xs font-medium leading-snug text-ink">{node.title}</div>
      <p data-lod="body" className="mt-1 line-clamp-3 font-serif text-xs leading-snug text-ink-muted">
